    ...
    <footer className="w-full pt-2">
      <div className="bg-[#f5f5f5] text-[#878787] px-4 py-4">
        <div className="bg-[#f5f5f5] text-[#878787] p-4 space-y-2">
          {/* Section 1 */}
          <div>
            <h2 className="font-medium  text-xs">Ecozon :</h2>
            <p className="text-xs leading-relaxed">
              ...
              only mobiles. Ecozon houses everything you can possibly imagine,
              ...
              those of you with erratic working hours, Ecozon is your best bet.
          ...
          {/* Section 2 */}
          <div>
            <h2 className="font-medium  text-xs">Mobile Phones</h2>
            <p className="text-xs leading-relaxed">
              ...
              Ecozon's Complete Mobile Protection Plan, you will never again
              ...
              and software glitches, and replacements the Ecozon Complete Mobile
              Protection covers a comprehensive range of post-purchase problems,
          ...
          {/* Section 3 */}
          <div>
            <h2 className="font-medium text-xs">EMI on Debit Cards</h2>
            <p className="text-xs leading-relaxed">
          ...
          {/* Section 4 */}
          <div>
            <h2 className="font-medium text-xs">Mobile Exchange Offers</h2>
            <p className="text-xs leading-relaxed">
          ...
          {/* Section 5 */}
          <div>
            <h2 className="font-medium text-xs">Large Appliances</h2>
            <p className="text-xs leading-relaxed">
              ...
              criteria will have the option to buy larger quantities. To know
              more on the eligibility criteria and terms and conditions, please
              reach out to
            </p>
          </div>
          ...
          {/* Section 6 */}
          <div>
            <h2 className="font-medium text-xs">Lifestyle</h2>
            <p className="text-xs leading-relaxed">
              Flipkart,
              <span className="font-medium text-xs">
                'India ka Fashion Capital'
              </span>
              , is your one-stop fashion destination for anything and everything
              you need to look good. Our exhaustive range of Western and Indian
              wear, summer and winter clothing, formal and casual footwear,
              bridal and artificial jewellery, long-lasting make-up, grooming
              tools and accessories are sure to sweep you off your feet. Shop
              from crowd favourites like Vero Moda, Forever 21, Only, Arrow,
              Woodland, Nike, Puma, Revlon, Mac, and Sephora among dozens of
              other top-of-the-ladder names. From summer staple maxi dresses,
              ...
              is up to date. Explore our in-house brands like Metronaut, Anmi,
              and Denizen, to name a few, for carefully curated designs that are
              the talk of the town. Get ready to be spoiled for
          ...
          {/* Section 7 */}
          <div>
            <h2 className="font-medium text-xs">Home and Furniture</h2>
            <p className="text-xs leading-relaxed">
              ...
              certification, ensuring they last you for up to 10 years. Yes, all
              our furniture has gone through 35 stability and load tests so that
              you receive only the best-quality furniture. Be FurniSure, always.
              Names to look out for are Nilkamal, Godrej Interio, Urban Ladder,
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed">
              ...
              lifestyle, screen size and many other criterias for greatest
              personalized results in a flash. All you students out there,
              confused about what samsung latest laptop to get? Our Back To
              College Store segregates laptops purpose wise (gaming, browsing
              and research, project work, entertainment, design, multitasking)
              with recommendatons from top brands and industry experts,
